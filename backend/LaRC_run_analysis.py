...
#filePathVibe = './DATA/LaRC_Data/LaRC_test8_run0030.txt' #set startTime = 125 timewWindow = 25
...
#filePathVibe = './DATA/LaRC_Data/LaRC_test18_run0050.txt' #set startTime = 85 timewWindow = 10
#filePathVibe = './DATA/LaRC_Data/LaRC_test19_run0052_noIRdata.txt' #set startTime = 97  timewWindow = 10
...
# signal_detrend_analysis(filePathVibe, startTime, timeWindow, cutoff, plotSegments=True, plotFFT=True, saveFreqs=False, saveFigures=False) # filePathVibe, startTime, timeWindow, cutoff, plotSegments=False, plotFFT=False, saveFreqs=False, saveFigures=False

# create_spectrograms(
#     filePathVibe=filePathVibe,
#     startTime=85,
#     timeWindow=10,
#     cutoff_freq=10
# )
...
#create_wavelet_scalograms(filePathVibe=filePathVibe, startTime =95, timeWindow=10, fs=5000, cutoff_freq=100)
