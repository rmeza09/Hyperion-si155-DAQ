...
# filePathVibe = './DATA/LaRC_Data/LaRC_test18_run0050.txt' #set startTime =  timewWindow = 
...
timeWindow = 30
cutoff = 100
dfVibe, timeSpanV, samplingFreqV = fileReader(filePathVibe, False, True, False, start_trim=startTime)
